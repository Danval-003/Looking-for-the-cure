 ...
 */
public class Mundo3 extends MyWorld
{
    ...
    public Mundo3()
    {
        ...
        addObject(new puerta3(),compox(1), compoy(10)-32);
        addObject(new puerta3(),compox(1), compoy(13)-32);
        addObject(new puerta2(),944,624);
        setMainActor(new Primer_jugador(), 200,180);
        mainActor.setLocation(compox(1), compoy(13));
