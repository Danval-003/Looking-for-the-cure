...
*Sección: 20
*Descripcion: Clase que incluye todos los niveles del juego y que se encarga de los ajustes
...
public class MyWorld extends World
{
   ...
   public MyWorld(int wide, int high, int cellSize, int scrollWide, int scrollHigh)
    {
    ...
    public MyWorld(int wide, int high, int cellSize, int scrollWide)
    {
